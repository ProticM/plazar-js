...
> A set of predefined components styled with Bootstrap CSS framework (version v4.1.x). Currently, this package should be used only in non module environments.
