...
```html
<script src="https://unpkg.com/@plazarjs/core@1.0.0-alpha.1/dist/core.min.js"> 
```
...
```
```html
<script src="https://unpkg.com/@plazarjs/bootstrap-ui@1.0.0-alpha.1/dist/bootstrap-ui.min.js">
```
