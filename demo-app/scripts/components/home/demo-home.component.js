plz.define('home-component', {
    ...
    template: '<div>Welcome to PlazarJS Demo Application. This demo uses <a href="https://bulma.io/" target="_blank">Bulma CSS Framework</a> ' + 
        ...
        '<a href="https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Flexible_Box_Layout/Basic_Concepts_of_Flexbox" target="_blank">Flexbox</a>. Note that usage of this framework is not required and it\'\s used to simplify this demo while focusing on PlazarJS features.' + 
